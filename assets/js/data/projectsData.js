...
export const PROJECTS_DATA = [
  ...
  },
  {
    ...
    status: "Produção Ativa",
    highlight: false,
    summary: "A arte da superengenharia para nunca mais digitar comandos longos: faz o mesmo que '$txt = tree /f /a; $txt | Out-File ...; $txt | Set-Clipboard', só que com 1 clique no menu de contexto do Windows, com DFS recursivo, blacklist inteligente de dependências, binário ps2exe e instalador Inno Setup.",
